...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="en"><body>
    <header className="nav"><div className="shell navin"><Link className="brand" href="/">Visibility<span>OS</span></Link><nav className="navlinks"><Link href="/timeline">Timeline</Link><Link href="/topics">Topics</Link><Link href="/evidence">Evidence</Link><Link href="/research">Research</Link><Link href="/search">Search</Link></nav></div></header>
    {children}
