...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="en"><body>
    ...
    {children}
    <footer className="footer"><div className="shell">Visibility OS is a living, evidence-backed reference system for AI discovery. Facts, interpretation and uncertainty are kept separate. <Link href="/about">About</Link> · <Link href="/people/neel-sen">Neel Sen</Link></div></footer>
  </body></html>
}
